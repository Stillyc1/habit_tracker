...
class Habit(models.Model):
    ...
    SignPleasantHabit = models.BooleanField(verbose_name='Признак приятной привычки')
    RelatedHabit = models.ForeignKey('habit_tracker.Habit', on_delete=models.SET_NULL, null=True, blank=True,
    ...
    Reward = models.CharField(max_length=255, verbose_name='Вознаграждение', help_text='Вознаграждение', null=True,
                              blank=True)
    TimeToComplete = models.PositiveIntegerField(verbose_name='Время на выполнение (не больше 120сек)',
                                                 help_text='Введите время выполнения привычки (не больше 120сек)')
    SignPublic = models.BooleanField(verbose_name='Признак публичной привычки')
